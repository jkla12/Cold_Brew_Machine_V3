...
#define SD_CLK_DIV_TRANS                    ((uint16_t)0x0001)        /* SD clock division in transmission phase */
...
static uint32_t transmode = SD_DMA_MODE;  //SD_POLLING_MODE
